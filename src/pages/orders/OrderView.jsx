...
const OrderView = () => {
  ...
  useEffect(() => {
    ...
    // For now, using mock data and finding the order by ID
    const aMockOrders = [
    {
      id: '1',
  ...
  if (nError) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-red-600 text-lg">Error loading order details: {nError.message}</div>
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-2  print:bg-white">
      <div>
       ...
       <div className="mb-8">
               ...
               <p className="text-gray-500">Order #{order.orderNumber || order.id}</p>
             </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 print:grid-cols-1 print:gap-4">
          ...
          <div className="lg:col-span-1 flex flex-col gap-6 print:gap-4">
            ...
            <div className="rounded-lg p-6 bg-white shadow-sm border border-gray-100 print:rounded-none print:shadow-none print:border print:p-4">
              <div>
                <div className="flex items-center space-x-3 mb-4 print:mb-3">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 print:text-base">Customer Details</h4>
                </div>
                <div className="space-y-3 text-gray-700 print:space-y-2 print:text-gray-800">
                   <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600 print:text-[10px]">Customer</p>
                      </div>
                    </div>
                  <div className="flex items-center space-x-3">
                    <Mail className="h-4 w-4 text-gray-500 print:hidden" />
                    <p className="text-sm print:text-xs">{order.customer?.email || 'N/A'}</p>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Phone className="h-4 w-4 text-gray-500 print:hidden" />
                    <p className="text-sm print:text-xs">{order.customer?.phone || 'N/A'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-sm border border-gray-100 print:rounded-none print:shadow-none print:border print:p-4">
              <div>
                <div className="flex items-center space-x-3 mb-4 print:mb-3">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 print:text-base">Delivery Information</h4>
                </div>
                <div className="space-y-3 text-gray-700 print:space-y-2 print:text-gray-800">
                  <div className="flex items-start space-x-3">
                    <Building className="h-4 w-4 text-gray-500 mt-1 print:hidden" />
                    <div>
                      <p className="text-sm print:text-xs">{order.delivery?.address || 'N/A'}</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm print:text-xs">Standard Delivery</p>
           ...
           <div className="rounded-lg p-6 bg-white shadow-sm border border-gray-100 print:rounded-none print:shadow-none print:border print:p-4">
              <div className="flex items-center space-x-3 mb-4 print:mb-3">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 print:text-base">Payment Information</h4>
                </div>
               <div className="space-y-3 bg-whitetext-gray-700 print:space-y-2 print:text-gray-800">
                 <div className="flex items-center justify-between">
                    <span className="text-sm print:text-xs">Payment Method</span>
                    <span className="text-sm font-medium print:text-xs">Credit Card</span> {/* Replace with actual payment method */}
                  </div>
                   <div className="flex items-center justify-between">
                    <span className="text-sm print:text-xs">Transaction ID</span>
          ...
          <div className="lg:col-span-2 flex flex-col gap-6 print:gap-4">
             ...
             {/* Order Summary Card - Moved to right column for larger screens */}
             ...
             <div className="hidden bg-white lg:block rounded-lg p-6 shadow-sm border border-gray-100 print:rounded-none print:shadow-none print:border print:p-4">
                <div>
                  <div className="flex items-center space-x-3 mb-4 print:mb-3">
                    ...
                    <h4 className="text-lg font-semibold text-gray-900 print:text-base">Order Summary</h4>
                  </div>
                  <div className="space-y-3 bg-white print:space-y-2 text-gray-700 print:text-gray-800">
                    <div className="flex items-center justify-between">
                      <span className="text-sm print:text-xs">Order Date</span>
                     ...
                     <div className="flex items-center justify-between">
                      <span className="text-sm print:text-xs">Order Time</span>
                      <div className="flex items-center text-sm text-gray-900 font-medium print:text-xs">
                     ...
                     <div className="flex items-center justify-between font-medium border-t border-gray-100 pt-3 mt-3 print:border-gray-200 print:pt-2 print:mt-2">
                      <span className="text-base text-gray-900 print:text-sm">Total Amount</span>
                      <span className="text-lg font-bold text-[#5B45E0] print:text-base">${order.total?.toFixed(2) || '0.00'}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-lg shadow-sm border border-gray-100 print:rounded-none print:shadow-none print:border print:p-4">
              <div className="px-6 py-4 border-b border-gray-200 print:px-3 print:py-2 print:border-b print:border-gray-300">
                <h4 className="text-lg font-semibold text-gray-900 print:text-base">Order Items</h4>
              </div>
              <div className="overflow-x-auto print:overflow-visible">
                <table className="min-w-full divide-y divide-gray-200 print:text-sm print:divide-gray-300">
                  <thead className="bg-gray-100 print:bg-white">
                    <tr>
                      <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider print:px-3 print:py-2 print:text-xs">Product</th>
                      <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider print:px-3 print:py-2 print:text-xs">Price</th>
                      <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider print:px-3 print:py-2 print:text-xs">Quantity</th>
                      <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider print:px-3 print:py-2 print:text-xs">Total</th>
                      <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-600 uppercase tracking-wider print:px-3 print:py-2 print:text-xs">Actions</th>
                    </tr>
                  </thead>
                ...
                <tfoot className="bg-gray-100 print:bg-white">
                  <tr>
                    <td colSpan="3" className="px-6 py-3 text-left text-base font-semibold text-gray-900 print:px-3 print:py-2 print:text-sm">Subtotal</td>
                    <td colSpan="2" className="px-6 py-3 text-right text-base font-semibold text-gray-900 print:px-3 print:py-2 print:text-sm">${order.total?.toFixed(2) || '0.00'}</td>
                  </tr>
                   <tr>
                    <td colSpan="3" className="px-6 py-3 text-left text-base font-semibold text-gray-900 print:px-3 print:py-2 print:text-sm">Shipping</td>
                   ...
                   <tr>
                    <td colSpan="3" className="px-6 py-3 text-left text-base font-semibold text-gray-900 print:px-3 print:py-2 print:text-sm">Tax</td>
                    <td colSpan="2" className="px-6 py-3 text-right text-base font-semibold text-gray-900 print:px-3 print:py-2 print:text-sm">$0.00</td>
                  </tr>
                  <tr>
                    <td colSpan="3" className="px-6 py-3 text-left text-lg font-bold text-gray-900 print:px-3 print:py-2 print:text-base">Order Total</td>
                    <td colSpan="2" className="px-6 py-3 text-right text-lg font-bold text-[#5B45E0] print:px-3 print:py-2 print:text-base">${order.total?.toFixed(2) || '0.00'}</td>
                  </tr>
                </tfoot>
              </table>
            </div>
